...
<div id="hilang">
    ...
    <a href="<?= base_url('laporanpdf/pemasukan') ?>"><button type="submit" class="btn btn-light">Cetak</button></a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content bg-dark">
      ...
      <form method="post" action="<?= base_url('pemasukan/simpan') ?>">
                      ...
                      foreach($pemasukan as $aa){ ?>
                        <tr>
                            ...
                            <td>
                                ...
                                href="<?= base_url('pemasukan/hapus/'.$aa['id_transaksi']) ?>"><button class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button></a>
                            </td>
                        </tr>
                        <?php }?>
                    </tbody>
